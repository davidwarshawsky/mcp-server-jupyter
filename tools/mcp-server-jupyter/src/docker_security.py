...
class SecureDockerConfig:
    ...
    ulimits: Dict[str, Tuple[int, int]] = field(default_factory=lambda: {
        ...
        "syscalls": [
            {
                "names": [
                    ...
                    "readv", "writev", "access", "pipe", "select", "dup", "dup2",
                    "pause", "nanosleep", "alarm", "getpid", "sendfile", "socket",
                    ...
                    "pread64", "pwrite64", "readahead", "mremap", "msync", "mincore",
                    "madvise", "shmget", "shmat", "shmctl", "dup3", "fchownat",
                    "futex", "set_robust_list", "get_robust_list", "epoll_create",
                    "epoll_ctl", "epoll_wait", "epoll_pwait", "epoll_create1",
                    "eventfd", "eventfd2", "signalfd", "signalfd4", "timerfd_create",
                    "timerfd_settime", "timerfd_gettime", "accept4", "recvmmsg",
                    "fanotify_mark", "prlimit64", "getrandom", "memfd_create",
                    "bpf", "execveat", "seccomp", "copy_file_range", "preadv2",
                    "pwritev2", "statx"
                ],
