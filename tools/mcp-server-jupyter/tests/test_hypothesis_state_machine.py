...
class TestNotebookProperties:
    ...
    def test_notebook_hash_changes_on_modification(self, cell_sources: List[str], new_source: str):
        ...
        # Add new cell
        notebook.add_cell(MockCell(f"cell_new", new_source))
...
class TestKernelExecutionProperties:
    ...
    def test_re_executing_cell_updates_count(self, cell_sources: List[str], rerun_idx: int):
...
class TestConcurrentOperations:
    ...
    def test_concurrent_cell_execution(self, cell_sources: List[str], idx1: int, idx2: int):
