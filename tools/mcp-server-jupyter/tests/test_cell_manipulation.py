...
import pytest
import nbformat
from src.notebook import move_cell, copy_cell, merge_cells, split_cell, change_cell_type
...
class TestCopyCell:
    ...
    def test_copy_cell_clears_outputs(self, create_test_notebook):
        ...
        nb_path = create_test_notebook(
            "test.ipynb", cells=[{"type": "code", "source": "print('hello')"}]
        )
    ...
    def test_copy_markdown_cell(self, create_test_notebook):
        ...
        nb_path = create_test_notebook(
            "test.ipynb", cells=[{"type": "markdown", "source": "# Header"}]
        )
...
class TestMergeCells:
    ...
    def test_merge_with_custom_separator(self, create_test_notebook):
        ...
        merge_cells(nb_path, 0, 1, separator="\n# ---\n")
...
class TestSplitCell:
    ...
    def test_split_clears_outputs(self, create_test_notebook):
        ...
        nb_path = create_test_notebook(
            "test.ipynb", cells=[{"type": "code", "source": "print('a')\nprint('b')"}]
        )
...
class TestChangeCellType:
    ...
    def test_change_code_to_markdown(self, create_test_notebook):
        ...
        nb_path = create_test_notebook(
            "test.ipynb", cells=[{"type": "code", "source": "x = 1"}]
        )
    ...
    def test_change_to_raw(self, create_test_notebook):
        ...
        nb_path = create_test_notebook(
            "test.ipynb", cells=[{"type": "code", "source": "test content"}]
        )
    ...
    def test_change_preserves_content(self, create_test_notebook):
        ...
        nb_path = create_test_notebook(
            "test.ipynb", cells=[{"type": "code", "source": original_content}]
        )
