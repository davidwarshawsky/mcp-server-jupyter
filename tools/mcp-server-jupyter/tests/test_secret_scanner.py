...
class TestEntropyCalculation:
    ...
    def test_entropy_high_for_random_string(self):
        ...
        entropy_medium = scanner.calculate_shannon_entropy(
            "X9kL2mP8vQ4nZ7wR3tY6uI1oP5sA"
        )
...
class TestPatternDetection:
    ...
    def test_detect_stripe_key(self):
        ...
        # Use reversed string to avoid GitHub secret scanning false positive
        # This is a fake test key, not a real Stripe key
        fake_key = "4321jihgfedcba0987654321_evil_ks"[::-1]  # sk_live_ + 24 chars
...
class TestEntropyBasedDetection:
    ...
    def test_detect_high_entropy_string(self):
        ...
        high_entropy = [
            s for s in secrets if s.entropy >= scanner.HIGH_ENTROPY_THRESHOLD
        ]
    ...
    def test_detect_hex_encoded_secret(self):
        ...
        text = (
            "Secret: 8549e18794ed18bd630e8d2aa20d6800acc7b65337aa54d35a734e123dc1b2be"
        )
        secrets = scanner.scan_text(text)
...
class TestRedaction:
    ...
    def test_redact_multiple_secrets(self):
        ...
        text = (
            "AWS: AKIAIOSFODNN7EXAMPLE, OpenAI: sk-1234567890abcdefghij1234567890abcdef"
        )
        secrets = scanner.scan_text(text)
        redacted = scanner.redact_secrets(text, secrets)
