...
def register_asset_tools(mcp):
    ...
    from mcp_server_jupyter.security import validate_path
    import logging

    logger = logging.getLogger(__name__)

    @mcp.tool()
    def peek_asset(asset_path: str) -> list:
        """
    ...
    def prune_unused_assets(notebook_path: str, dry_run: bool = False):
        ...
        """
        from mcp_server_jupyter.asset_manager import prune_unused_assets as _prune_assets
    ...
    def get_assets_summary(notebook_path: str):
        ...
        """
        from mcp_server_jupyter.asset_manager import get_assets_summary as _get_summary
    ...
    def prune_assets(notebook_path: str = None, aggressive: bool = False):
        ...
        """
        from mcp_server_jupyter.asset_manager import prune_unused_assets as _prune_assets
        from mcp_server_jupyter.utils import check_asset_limits
        from pathlib import Path
