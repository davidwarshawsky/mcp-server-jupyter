...
tools: [
  # Core Notebook Operations (Use MCP, not VS Code basic tools)
  "mcp-jupyter/get_notebook_outline",
  "mcp-jupyter/create_notebook", 
  "mcp-jupyter/validate_notebook",
  "mcp-jupyter/search_notebook",
  # Cell Manipulation
  "mcp-jupyter/read_cell_smart",
  "mcp-jupyter/append_cell",
  "mcp-jupyter/insert_cell",
  # Safe edits with human approval
  "mcp-jupyter/propose_edit",  
  "mcp-jupyter/get_proposal_status",
  "mcp-jupyter/delete_cell",
  "mcp-jupyter/move_cell",
  "mcp-jupyter/merge_cells",
  "mcp-jupyter/change_cell_type",
  "mcp-jupyter/clear_all_outputs",
  # Async Execution (Background agent capable)
  "mcp-jupyter/start_kernel",
  "mcp-jupyter/run_cell_async",
  "mcp-jupyter/get_execution_status",
  "mcp-jupyter/run_all_cells",
  "mcp-jupyter/is_kernel_busy",
  "mcp-jupyter/cancel_execution",
  "mcp-jupyter/check_kernel_resources",
  
  # Variable & Data Inspection (Avoid context overflow)
  "mcp-jupyter/inspect_variable",
  "mcp-jupyter/get_variable_manifest",
  "mcp-jupyter/search_dataframe_columns",
  
  # Asset Management (Handle large outputs)
  "mcp-jupyter/peek_asset",
  "mcp-jupyter/read_asset",
  "mcp-jupyter/get_assets_summary",
  
  # Environment Management
  "mcp-jupyter/install_package",
  "mcp-jupyter/auto_detect_environment",
  "mcp-jupyter/check_code_syntax",
  
  # Kernel Control
  "mcp-jupyter/restart_kernel",
  "mcp-jupyter/interrupt_kernel",
  "mcp-jupyter/check_working_directory",
  "mcp-jupyter/set_working_directory",
  
  # Context & Reasoning
  "memory-sqlite/create_entities",
  "memory-sqlite/create_relations",
  "thinking/sequentialthinking",
  
  # Python Environment (VS Code Native)
  # Note: Copilot already has access to ms-python.python & ms-python.vscode-pylance
  # No need for third-party pylance-mcp-server
